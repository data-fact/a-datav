...
export default function Configer({component}){
    ...
    function handleLineColorChange(color) {
        updateComponent(id,{option: update(option,{line: {color: {$set: color}}})})
    }
    ...
    return (
        <>
            ...
            <Row>
                <Col span={6}>线颜色</Col>
                <Col span={14}>
                    <Palette color={option.line.color} onChange={handleLineColorChange}/>
                </Col>
                <Col span={4}>
                    <DeleteOutlined onClick={() => handleLineColorChange('')}/>
                </Col>
            </Row>
            <Row>
                <Col span={6}>区域颜色</Col>
