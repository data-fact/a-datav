...
export default function Configer({component}){
    ...
    let {i: id,_data:data,columns,table,pagination} = component
    ...
    function handlePaginationChange(key,value) {
        updateComponent(id,{pagination: update(pagination,{[key]: {$set: value}})})
    }
            ...
            >
                <Tabs size="small" style={{ width: '100%',height: '100%' }}>
                    ...
                    <TabPane
                        ...
                        tab="分页配置"
                    >
                        <PaginationConfiger pagination={pagination} onChange={handlePaginationChange}/>
                    </TabPane>
                </Tabs>
            </Card>
        </>
