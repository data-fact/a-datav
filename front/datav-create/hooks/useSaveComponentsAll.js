...
export default function useSaveComponentsAll(){

    let setLoading = useSetMainLoading()

    function saveComponentsAll(datavId,components) {
        setLoading(true)
        fetch(`../component/update-all?datavId=${datavId}`,{
            method:'POST',
            headers:{
