package com.aleiye.adatav.filter;

import com.aleiye.adatav.security.AccountUser;
import com.aleiye.adatav.security.JwtAuthenticationToken;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        request.setAttribute("user-id","0");
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        request.setAttribute("user-id",userDetails.getUserId());
